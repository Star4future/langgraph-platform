...
// sse-client.ts
var ThreadEvent = external_exports.object({
  type: external_exports.literal("thread"),
  thread_id: external_exports.string()
});
var TriageEvent = external_exports.object({
  type: external_exports.literal("triage"),
  intent: external_exports.string(),
  confidence: external_exports.number(),
  urgency: external_exports.string()
});
var ToolCallEvent = external_exports.object({
...
var ToolResultEvent = external_exports.object({
  type: external_exports.literal("tool_result"),
  tool: external_exports.string(),
  result: external_exports.unknown()
});
var TokenEvent = external_exports.object({
  type: external_exports.literal("token"),
  delta: external_exports.string()
});
var HumanEscalationEvent = external_exports.object({
  type: external_exports.literal("human_escalation"),
  session_id: external_exports.string(),
  reason: external_exports.string(),
  draft_quality: external_exports.number()
});
var DoneEvent = external_exports.object({
...
var ErrorEvent = external_exports.object({
...
function separatorLength(s, at) {
  return s.startsWith("\r\n\r\n", at) ? 4 : 2;
}
async function* streamChat(baseUrl, req) {
